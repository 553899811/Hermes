 ...
 */
public class RpcAsyncProxyImpl<T> implements RpcAsyncProxy, InvocationHandler {
    ...
    public RpcAsyncProxyImpl(RpcConnectManager rpcConnectManager, Class<T> clazz, long timeout) {
        this.clazz = clazz;
